  ...
  template: `
    <div class="min-h-[calc(100vh-80px)] bg-emerald-50 flex flex-col relative overflow-hidden">
      ...
      <section class="relative z-10 px-4 pt-20 pb-16 md:pt-32 md:pb-24 max-w-7xl mx-auto w-full flex flex-col items-center text-center">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto mt-6">
        ...
        <!-- Contact Integration Icons -->
        <div class="mt-12 flex flex-col md:flex-row items-center justify-center gap-10 sm:gap-16">
          <div class="flex flex-col items-center gap-3">
            <a href="https://wa.me/923167546414" target="_blank" class="w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center text-white hover:scale-110 transition-transform shadow-lg shadow-[#25D366]/20 relative overflow-hidden group" title="WhatsApp Us">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 16 16" class="relative z-10 w-8 h-8">
              ...
              <div class="absolute inset-0 bg-white/20 transform scale-0 group-hover:scale-100 transition-transform rounded-full"></div>
            </a>
            <div class="text-sm font-bold text-emerald-800">WhatsApp: +923167546414</div>
          </div>
          
          <div class="flex flex-col items-center gap-3">
            <a href="mailto:xylogleam@gmail.com" class="w-14 h-14 rounded-full bg-[#EA4335] flex items-center justify-center text-white hover:scale-110 transition-transform shadow-lg shadow-[#EA4335]/20 relative overflow-hidden group" title="Email Us">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 16 16" class="relative z-10 w-8 h-8">
                <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555ZM0 4.697v7.104l5.803-3.558L0 4.697ZM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757Zm3.436-.586L16 11.801V4.697l-5.803 3.546Z"/>
              </svg>
              <div class="absolute inset-0 bg-white/20 transform scale-0 group-hover:scale-100 transition-transform rounded-full"></div>
            </a>
            <div class="text-sm font-bold text-emerald-800">Email: xylogleam@gmail.com</div>
          </div>
        </div>
